...
parcela_atual = st.number_input("💳 Parcela Atual (R$)", min_value=0.01, value=0.01, step=10.0, format="%.2f")
prazo_inicial = st.number_input("📆 Prazo (nº de parcelas)", min_value=1, max_value=96, value=1)
taxa_max = st.number_input("📉 Taxa de Juros (% ao mês)", min_value=0.01, value=0.0001, step=0.01, format="%.4f") / 100
